...
├── SYNTHESIS.md                       # Comprehensive synthesis of all research
├── experts/                           # Key figure deep profiles
│   ├── 01-jeff-park.md               # Jeff Park (ProCap BTC CIO, ex-Bitwise)
...
## Expert Profiles Index

### File 01: Jeff Park (Full Deep Profile)
- **Role:** CIO at ProCap BTC, Bitwise Advisor
- **Key frameworks:** Radical Portfolio Theory, Two Bitcoin Thesis, Plaza Accord 2.0, Peacetime vs Wartime Bitcoin
- **Current stance:** Bear market short-term, deeply bullish long-term
- **Notable:** Named crypto's first "Hedge Fund Rising Star" by Institutional Investor

### File 02: Samson Mow + Key Figures
- **Samson Mow** -- JAN3 CEO, $1.33M BTC prediction, Volcano Bond advocate
- **Michael Saylor** -- 717,722 BTC, "digital energy" thesis
- **Larry Fink** -- BlackRock IBIT, $700K BTC vision
- **Cathie Wood** -- ARK Invest, $1.2M BTC bull case by 2030
- **Jack Mallers** -- Strike + Twenty One Capital (Tether/SoftBank backed)
- **Lyn Alden** -- Macro Bitcoin analyst
- **Balaji Srinivasan** -- Network State thesis
- **Vitalik Buterin** -- Ethereum "Strawmap" 1,000x scaling
- **Adam Back** -- Blockstream CEO, PoW inventor
- **Elizabeth Stark** -- Lightning Labs, Taproot Assets
- **Paolo Ardoino** -- Tether ($10-15B profit 2025)
- **CZ** -- Pardoned by Trump, advising 12 governments
- **Brian Armstrong** -- Coinbase institutional crypto
- **Andreas Antonopoulos** -- Bitcoin education pioneer

### File 03: Institutional Leaders
- **Michael Saylor** -- 717,722 BTC, $12.4B Q4 loss, "digital credit" framework
- **Cathie Wood** -- ARK #1 ETF issuer 2025, 4-year cycle "disrupted"
- **Larry Fink** -- "Tokenize every asset", IBIT peaked $100B AUM
- **SEC (Gensler to Atkins)** -- 180-degree pivot, "Project Crypto"
- **Vitalik Buterin** -- Quantum resistance roadmap, rollup rethink
- **Charles Hoskinson** -- Midnight privacy chain launching March 2026
- **Anatoly Yakovenko** -- Firedancer live, Alpenglow 150ms finality
- **Hayden Adams** -- UNIfication: 100M UNI burned, fee switch on
- **Do Kwon** -- 15-year sentence (Dec 2025)
- **Sam Bankman-Fried** -- 25 years, new trial request denied

### File 04: VCs, Traders & Emerging Voices
- **Chris Dixon** -- a16z crypto, $7B+ funds, *Read Write Own*
- **Kyle Samani** -- Multicoin, stepped down Feb 2026, Forward Industries
- **Su Zhu & Kyle Davies** -- 3AC collapse aftermath, $3.3B owed
- **Barry Silbert** -- DCG, Grayscale chairman return, pivoting to AI
- **Mike Novogratz** -- Galaxy Digital on Nasdaq, "end of speculation"
- **Cobie** -- Echo acquired by Coinbase for $375M
- **Hsaka** -- Perpetual futures specialist
- **GCR** -- Anonymous legend, $12M Hyperliquid position
- **Erik Voorhees** -- Venice AI, VVV token +375%
- **Jameson Lopp** -- Casa CSO, cypherpunk, Bitcoin security
- **Alex Gladstein** -- HRF, Bitcoin as freedom money
- **Natalie Brunell** -- *Bitcoin is for Everyone*, 10M+ podcast downloads

### File 05: Analysts & Advocates
- **Raoul Pal** -- 5.4-year cycle, $140K target, "retail rotated to AI"
- **Arthur Hayes** -- AI credit crisis thesis, $200K BTC, "nearly fully invested"
- **Willy Woo** -- Bear trend strengthening, $45K bottom, recovery H1 2027
- **PlanB** -- S2F model, 4 bear scenarios ($25K-$80K range)
- **Nic Carter** -- Quantum risk as existential threat, stablecoin policy
- **Caitlin Long** -- Custodia Bank vs Fed battle ongoing
- **Anthony Pompliano** -- "Best-performing bear market ever", $0 or $1M
- **Dan Held** -- Supercycle thesis, pivoting to Bitcoin DeFi
- **Murad Mahmudov** -- Memecoin portfolio crashed 86% ($67M to $9.1M)
- **Robert Kiyosaki** -- Buying at $67K, $250K target
...
| Metric | Value |
|--------|-------|
| BTC Price | ~$65,000 (down 49% from $126K ATH) |
| Total Crypto Market Cap | ~$2.2-2.4T |
| BTC Dominance | 58-60% |
| Fear & Greed Index | 11 (Extreme Fear) |
| BTC ETF AUM | ~$81B (down 30% from $117B) |
| US Strategic BTC Reserve | ~328,372 BTC |
| Stablecoin Market Cap | $317B |
...
1. **Bear market with structural maturity** -- Price down 49% but infrastructure (ETFs, banking, regulation) dramatically stronger
2. **ETF structure paradox** -- $54B cumulative inflows but price suppressed by AP hedging mechanics
3. **Regulatory 180** -- SEC "Project Crypto" replacing enforcement-first approach
4. **Stablecoins as breakout infrastructure** -- $300B+ market, GENIUS Act, major bank adoption
5. **RWA tokenization inflection** -- $25B+ on-chain, 300% growth, SEC clarity
6. **AI x Crypto convergence** -- Venice AI, decentralized compute, AI agent payments
7. **Nation-state adoption accelerating** -- US Strategic Reserve, El Salvador, Pakistan
