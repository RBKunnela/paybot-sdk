...
## Activation Protocol
1. Load `.claude/agents/master.md` as IDE wrapper (fallback: `.aios-core/development/agents/aios-master.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .aios-core/development/scripts/generate-greeting.js master` and show it first.
