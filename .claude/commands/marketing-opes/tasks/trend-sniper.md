...
### Via Script (cron)
```bash
python3 expansion-packs/marketing-opes/scripts/trend_sniper.py
python3 expansion-packs/marketing-opes/scripts/trend_sniper.py --dry-run
python3 expansion-packs/marketing-opes/scripts/trend_sniper.py --history
python3 expansion-packs/marketing-opes/scripts/trend_sniper.py --force
```

### Via Cron (automatico)
```
*/30 8-21 * * * cd /Users/josecarlosamorim/mmos && python3 expansion-packs/marketing-opes/scripts/trend_sniper.py >> outputs/hubs/marketing/trends/cron.log 2>&1
```
