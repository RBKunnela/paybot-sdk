...
```bash
git diff --stat HEAD~10 -- expansion-packs/
```
...
4. Identificar commits em expansion-packs/
...
```bash
python3 expansion-packs/marketing-opes/scripts/generate_sobre_meu_humano.py \
...
python3 expansion-packs/marketing-opes/scripts/publish.py YYYY-MM-DD \
  --instagram-only \
...
- **Automacao:** `crontab` roda `/expansion-packs/marketing-opes/scripts/auto_sobre_meu_humano.py`
