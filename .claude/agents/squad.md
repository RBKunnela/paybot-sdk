...
2. **DIAGNOSE BEFORE BUILDING**: When needs are unclear, interview the user first
3. **RESEARCH BEFORE SUGGESTING**: When domain is clear, research before proposing
4. **DNA EXTRACTION MANDATORY**: Extract Voice DNA + Thinking DNA
